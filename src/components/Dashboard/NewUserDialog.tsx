            ...
            <div className="space-y-2 inline-block w-full max-w-2xl p-4 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-lg max-h-screen overflow-y-auto">
                <div className="mt-2 h-full space-y-2 py-2 max-h-[70vh] overflow-y-auto">
                  <article className="prose">
                    ...
                    <p>Catalyst is a mentorship organization for passionate economics students who wish to learn more about economics/business from college mentors.</p>
                    ...
                    <p>Catalyst doesn't just have mentors, there are many other Users waiting for you to find them. Use the Search Bar or click on each User's Profile and message them. It's all about building your network🌍</p> 
                    <br/>
                    <h2 className="text-blue-700">What are you waiting for! Go explore Catalyst!</h2> 
                  </article>
                </div>
